...
public class UsageResource extends ServerResource
{
    ...
    private static String getHeader() {
        return "<!DOCTYPE html>\n" +
                ...
                "       <!-- jQuery -->\n" +
                "    <script type=\"text/javascript\" src=\"https://www.netztest.at/js/jquery-1.8.2.min.js\"></script>\n" +
                "    <!-- FLOT (flotcharts.org -->\n" +
                "    <script type=\"text/javascript\" src=\"https://www.netztest.at/js/jquery.flot.min.js\"></script>\n" +
                "    <!-- FLOT time -->\n" +
