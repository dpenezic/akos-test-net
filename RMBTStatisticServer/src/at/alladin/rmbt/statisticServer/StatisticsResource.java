...
public class StatisticsResource extends ServerResource
{
    ...
    private String generateStatistics(final StatisticParameters params, final String cacheKey)
    {
        ...
        try (Connection conn = DbConnection.getConnection())
        {
            ...
            try (PreparedStatement ps = selectProviders(conn, true, quantile, durationDays, accuracy, country, useMobileProvider, where, signalMobile);
            ...
            try (PreparedStatement ps = selectDevices(conn, true, quantile, durationDays, accuracy, country, useMobileProvider, where, maxDevices);
                ResultSet rs = ps.executeQuery())
            {
    ...
    private PreparedStatement selectProviders(final Connection conn, final boolean group, final float quantile, final int durationDays, final double accuracy,
