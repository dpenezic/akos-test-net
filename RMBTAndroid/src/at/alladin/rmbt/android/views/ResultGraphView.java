...
public class ResultGraphView extends ScrollView implements EndTaskListener {
	...
	static {
		...
		SPEED_LABELS.add(new GraphLabel("0.0", "#C800f940"));
		SPEED_LABELS.add(new GraphLabel("0.1", "#C800f940"));
		SPEED_LABELS.add(new GraphLabel("1.0", "#C800f940"));
...
//	}
	...
	public void drawCurve(JSONArray graphArray, CustomizableGraphView graphView, String color, String labelHMax) throws JSONException {
		...
		GraphService signal = SmoothGraph.addGraph(graphView, Color.parseColor(color), RMBTTestFragment.SMOOTHING_DATA_AMOUNT, 
